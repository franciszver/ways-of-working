...
Screenshot the rendered result — the work is unverified until you have looked at it. Run all 4: resize test (narrow and wide), keyboard-tab test (focus visible), squint test, both-themes test. Then confirm the Step 5 states render correctly with real data. "It works" is not a design verdict.
