---
name: api-design
description: Design interfaces from the caller's side — sample calls first, explicit contract including errors, evolution planned before v1. Use when designing or reviewing an API, library surface, CLI, or event schema.
---
