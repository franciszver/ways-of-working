...
<!-- local: derived-from: skills/local-llm-loop/SKILL.md@897b24608a42 -->
...
5. If your reply is cut off at the output limit, you printed too much. Never print file contents in a reply; read at most 40 lines per call, write the file you were asked for first, then stop.
...
9. Before you stop, write the state file in the `handoff` skill's format so a fresh session with no memory of this one can resume from it alone.
