...
Load and follow the skill at `.agents/skills/apply-working-process/SKILL.md` (or `.agent/skills/apply-working-process/SKILL.md`). Apply it to the argument given with the command.
