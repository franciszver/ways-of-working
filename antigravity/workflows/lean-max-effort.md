...
Load and follow the skill at `.agents/skills/lean-max-effort/SKILL.md` (or `.agent/skills/lean-max-effort/SKILL.md`). Apply it to the argument given with the command.
