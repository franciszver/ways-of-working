...
Load and follow the skill at `.agents/skills/research-codebase/SKILL.md` (or `.agent/skills/research-codebase/SKILL.md`). Apply it to the argument given with the command.
