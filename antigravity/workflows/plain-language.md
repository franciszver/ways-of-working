...
Load and follow the skill at `.agents/skills/plain-language/SKILL.md` (or `.agent/skills/plain-language/SKILL.md`). Apply it to the argument given with the command.
