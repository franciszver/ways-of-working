...
Load and follow the skill at `.agents/skills/data-analysis/SKILL.md` (or `.agent/skills/data-analysis/SKILL.md`). Apply it to the argument given with the command.
