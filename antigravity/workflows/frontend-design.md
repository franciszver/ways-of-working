...
Load and follow the skill at `.agents/skills/frontend-design/SKILL.md` (or `.agent/skills/frontend-design/SKILL.md`). Apply it to the argument given with the command.
