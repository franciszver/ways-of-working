...
REFERENCE_ALLOWLIST = {
    ...
    "SIMPLIFY.md": {("skills", "local-llm-loop")},
    "SECURITY.md": {("skills", "local-llm-loop")},
    "FINDINGS.md": {("skills", "local-llm-loop")},
    "REJECTED_FINDINGS.md": {("skills", "local-llm-loop")},
    "NEEDS_HUMAN.md": {("skills", "local-llm-loop")},
