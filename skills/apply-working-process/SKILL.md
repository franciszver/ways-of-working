...
- The orchestrator itself runs on the strongest available tier by default. If that tier is not available, offer to switch the orchestrator to Opus at high reasoning effort instead of silently downgrading.
