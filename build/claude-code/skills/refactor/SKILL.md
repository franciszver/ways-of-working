---
name: refactor
description: Behavior-preserving refactoring protocol — establish a test net first,
  transform in small verified steps, never mix structure changes with behavior changes.
  Use when restructuring, extracting, renaming, moving, de-duplicating, or modernizing
  code, or when asked to "clean up" working code.
---
