---
name: spec
description: Turns a request into a numbered requirements ledger with acceptance criteria,
  explicit non-goals, surfaced ambiguities, and the riskiest assumption marked. Use
  when requirements are fuzzy or contradictory, when scoping a feature, or when asked
  for a spec.
---
