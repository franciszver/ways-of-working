---
name: ste-writing
description: 'Writes all prose in the spirit of ASD-STE100 Simplified Technical English
  — one word per idea, short active-voice sentences, one topic per paragraph. Use
  whenever writing prose a person will read: docs, commit messages, PR text, reports,
  replies, code comments.'
---
