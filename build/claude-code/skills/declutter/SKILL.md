---
name: declutter
description: Cleanup-only pass that applies behavior-preserving simplifications to
  a diff before it ships — duplicate logic folded into existing helpers, dead code
  removed, needless indirection collapsed. Not a bug hunt and not a redesign. Use
  as a quality gate before opening a PR, after generated/AI-written code, or when
  asked to simplify/clean up recent changes.
argument-hint: '[file|dir|branch]'
---
