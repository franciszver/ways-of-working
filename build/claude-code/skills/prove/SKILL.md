---
name: prove
description: Proves work actually works before calling it done — strongest available
  evidence per claim, edge-case hunt, regression check, verbatim output quotes, and
  honest "I verified / I did not verify" verdicts. Use before reporting any task complete,
  before commits and handoffs, after fixes, and whenever the user asks "does it work?".
---
