---
name: research
description: Triangulated research with a citation log — primary sources first, two
  independent sources for load-bearing claims, disconfirmation hunting, synthesis
  that separates fact from inference. Use for any research task — technical evaluations,
  "which X should we use", market/landscape questions, fact-finding, due diligence
  — and before answering factual questions where being wrong is costly. For questions
  about this codebase, use `research-codebase` instead.
---
