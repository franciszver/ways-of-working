---
name: estimate
description: Estimates with stated uncertainty instead of theater — decompose, size
  against comparable past work, widen for the unknowns you can name and the ones you
  can't, give a range with assumptions attached. Use when asked how long/how big/how
  much effort something is, when scoping or prioritizing work, or when a deadline
  is being negotiated.
---
