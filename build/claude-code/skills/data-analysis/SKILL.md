---
name: data-analysis
description: Analysis that survives scrutiny — interrogate the data's provenance and
  quality before computing, distinguish exploration from confirmation, quantify uncertainty,
  report what would change the conclusion. Use when exploring a dataset, answering
  a question with data, building metrics/dashboards, evaluating an experiment, or
  checking someone else's numbers.
---
