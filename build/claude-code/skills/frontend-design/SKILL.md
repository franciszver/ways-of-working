...
description: Makes interfaces look designed, not defaulted — commits to a design language
  before the first component, spends hierarchy before decoration, designs the real
  states, and verifies by looking at the rendered result. Use when building or restyling
  any UI — web app, landing page, dashboard, component library — or when a working
  interface "looks off" and needs design quality.
---
