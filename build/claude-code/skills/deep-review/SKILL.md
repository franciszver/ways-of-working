---
name: deep-review
description: Adversarial code review that reports only verified, severity-ranked findings
  with concrete failure scenarios — no speculation, no style-nit flooding. Use when
  asked to review code, a diff, a branch, or a PR; before merging significant work;
  or to attack your own completed work with fresh hostility.
argument-hint: '[file|dir|branch|PR]'
---
