---
name: perf
description: Performance work driven by measurement — profile before touching code,
  fix the top bottleneck, re-measure, stop at the target. Use when something is slow,
  uses too much memory, or costs too much; when asked to optimize; or when setting
  performance budgets.
