---
name: onboard
description: Builds an accurate working model of an unfamiliar codebase fast — orients
  from the artifacts, traces one real flow end-to-end, verifies beliefs against runtime
  behavior, writes down the map built. Use when joining a project, picking up an unfamiliar
  repo/service/module, or before making changes in code you've never touched.
argument-hint: <module|repo>
---
