---
name: api-design
description: Designs interfaces from the consumer's side — writes the calls you wish
  existed, makes the contract explicit including errors, plans evolution before v1
  ships. Use when designing or reviewing an HTTP/RPC API, a library's public surface,
