---
name: pr-workflow
description: Branch-to-merge hygiene that makes changes reviewable — one concern per
  PR, commits that tell the story, a description that fronts the why and the risk,
  review turnaround treated as production work. Use when creating branches/commits/PRs,
  preparing work for review, splitting an oversized change, or responding to review.
---
