---
name: plain-language
description: Reads a draft against the current published signs of AI writing and strikes
  what matches. Use whenever prose will be read by a person, especially anything shipped
  publicly (docs, README, UI copy, PR and issue text, emails, applications). Complements
